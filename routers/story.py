...
def get_complete_story(story_id: int, db: Session = Depends(get_db)): #story_id will be populated with the {story_id} in the url, as long as they have the same name and parameter is between {}
